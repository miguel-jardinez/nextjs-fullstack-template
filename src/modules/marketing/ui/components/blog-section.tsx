...
import { Card, CardContent, CardFooter } from "@template/components/ui/card";
...
const BlogSection = () => {
  ...
  const isTablet = screenSize.isTablet ? 2 : 1;
  const visibleItems = screenSize.isDesktop ? 3 : isTablet;
